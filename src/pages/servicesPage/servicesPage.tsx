...
import FormModalContentWrapper from "../../components/formModalContentWrapper/formModalContentWrapper";
...
const ServicesPage: React.FC = () => {
  ...
  const modalContents = [
    <CardTariffModal
        ...
        <>
          <List title="В данный тариф входит:">
            <ListItem
              text={
                <p>
                  Полностью готовый магазин в Instagram с загруженным основным
                  контентом, что значительно упрощает вход в товарный бизнес
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  База поставщиков (РБ и РФ), которые работают уже не первый
                  месяц, и шанс быть обманутым равен 0! Все поставщики проверены
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Наш любой онлайн курс на выбор! Ты выбираешь один из трёх
                  курсов, который больше заинтересовал и внедряешь эти знания
                  в свою работу
                </p>
              }
            />
          ...
          <List title="Подойдёт для:">
            <ListItem
              text={
                <p>
                  Юных предпринимателей, которые уже покупали у кого-то курсы
                  и имеют минимальное понимание в товарном бизнесе
                  (если нет знаний про товарный бизнес, тогда советуем
            ...
            <ListItem
              text={
                <p>
                  Студентов, которые не хотят выживать на одну стипендию и их
                  тянет к бизнесу (если нет знаний про товарный бизнес, тогда
                  советуем присмотреться к тарифу «Стандарт» или «VIP»)
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Подарка другу или девушке, которые постоянно говорят про
                  бизнес и всё с этим связанное (многим понравится такой
                  подарок). Однозначно, такой подарок будет выделяться своей
                  оригинальностью
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Расширения. Если уже есть магазины и желание попробовать
                  другие ниши, то это идеальный вариант
                </p>
              }
            />
          </List>
      ...
      price="69"
      onButtonBuy={() => setFormModalActive(true)}
    />,
    <CardTariffModal
        ...
        <>
          <List title="В данный тариф входит:">
            ...
            <ListItem
              text={
                <p>
                  Онлайн консультация по запуску магазина. Можно задавать любые
            ...
            <ListItem
              text={
                <p>
                  Все 3 наших курса в подарок! Изучаешь все 3 курса и внедряешь
                  эти знания для значительного упрощения работы
                </p>
              }
            />
          </List>
          <List title="Подойдёт для:">
            <ListItem
              text={
                <p>
                  Юных предпринимателей, которые уже покупали у кого-то курсы
                  и имеют минимальное понимание в товарном бизнесе или не имеют
                  его вовсе
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Студентов, которые не хотят выживать на одну стипендию и их
                  тянет к бизнесу (здесь ты найдёшь всю основную информацию
                  про товарный бизнес)
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Подарка другу или девушке, которые постоянно говорят
                  про бизнес и всё с этим связанное. Однозначно, такой
                  подарок будет выделяться своей оригинальностью
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Расширения. Если уже есть магазины и есть желание попробовать
                  другие ниши, то это идеальный вариант! (Но советуем
                  присмотреться к тарифу «Старт», уверены у тебя уже хватает
                  знаний)
                </p>
              }
            />
        ...
        <>
          <List title="В данный тариф входит:">
            <ListItem
              text={
                <p>
                  Полностью готовый магазин в Instagram под твой товар.
                  От тебя требуется только название товара и фото для примера.
                  Магазин будет выполнен под ключ с твоим дизайном
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Поможем найти поставщиков (РБ и РФ), которые работают
                  уже не первый месяц, и шанс быть обманутым равен 0!
            ...
            <ListItem
              text={
                <p>
                  Онлайн консультация и сопровождение по запуску магазина. Можно
                  задавать любые вопросы, которые интересуют
                </p>
              }
            />
            <ListItem
          ...
          <List title="Подойдёт для:">
            <ListItem
              text={
                <p>
                  Юных предпринимателей, которые не имеют никакого понимания
                  в товарном бизнесе или имеют это понимание, но хотят магазин
            ...
            <ListItem
              text={
                <p>
                  Студентов, которые не хотят выживать на одну стипендию
                  и их тянет к бизнесу (здесь вы найдёте всю основную информацию
                  про товарный бизнес и получите консультацию по запуску
                  магазина)
                </p>
              }
            />
    ...
    <CardTariffModal
      ...
      description={
        <>
          <List title="В данный тариф входит:">
            <ListItem
              text={<p>Полностью готовый сайт (landing page) под твой товар</p>}
            />
            <ListItem
              text={
                <p>
          ...
          <List title="Подойдёт для:">
            <ListItem
              text={
                <p>
                  ...
                  и имеют минимальное понимание в товарном бизнесе
                  (если нет знаний про товарный бизнес, тогда советуем
                  присмотреться к тарифу «Стандарт плюс» или «VIP плюс»)
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Студентов, которые не хотят выживать на одну стипендию
                  и их тянет к бизнесу (если нет знаний про товарный бизнес,
                  тогда советуем присмотреться к тарифу «Стандарт плюс»
                  или «VIP плюс»)
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Подарка другу или девушке, которые постоянно говорят
                  про бизнес и всё с этим связанное (многим понравится такой
                  подарок). Однозначно, такой подарок будет выделяться своей
                  оригинальностью
                </p>
              }
        ...
        <>
          <List title="В данный тариф входит:">
            ...
            <ListItem
              text={
                <p>
                  Полностью готовый Instagram под товар с загруженным
                  основным контентом
                </p>
              }
            />
          ...
          <List title="Подойдёт для:">
            ...
            <ListItem
              text={
                <p>
                  Студентов, которые не хотят выживать на одну стипендию
                  и их тянет к бизнесу (здесь ты найдёшь всю основную информацию
                  про товарный бизнес)
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Подарка другу или девушке, которые постоянно говорят
                  про бизнес и всё с этим связанное. Однозначно, такой подарок
                  будет выделяться своей оригинальностью
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Расширения. Если уже есть магазины и есть желание попробовать
                  другие ниши, то это идеальный вариант! (Но советуем
                  присмотреться к тарифу «Старт плюс», уверены у тебя
                  уже хватает знаний)
                </p>
              }
            />
        ...
        <>
          <List title="В данный тариф входит:">
            <ListItem
              text={
                <p>
                  Полностью готовый сайт (landing page) и магазин в Instagram
                  под твой товар. От тебя требуется только название товара и
                  фото для примера. Магазин будет выполнен под ключ с твоим
                  дизайном
                </p>
              }
            />
          ...
          <List title="Подойдёт для:">
            ...
            <ListItem
              text={
                <p>
                  Студентов, которые не хотят выживать на одну стипендию и их
                  тянет к бизнесу (здесь вы найдете всю основную информацию
                  про товарный бизнес и получите консультацию по запуску
                  магазина)
                </p>
              }
            ...
            <ListItem
              text={
                <p>
                  Подарка другу или девушке, которые постоянно говорят про
                  бизнес и всё с этим связанное. Однозначно, такой подарок будет
                  выделяться своей оригинальностью
                </p>
              }
            />
            <ListItem
              text={
                <p>
                  Расширения. Если уже есть магазины и есть желание попробовать
                  другие ниши, то это идеальный вариант! (Но советуем
                  присмотреться к тарифу «Старт плюс», уверены у тебя уже
                  хватает знаний)
                </p>
              }
            />
  ...
  return (
    <>
      ...
      <Modal
        active={modalActive && !formModalActive}
        setActive={setModalActive}
        zIndex="3"
      >
        <CardBorderGradient isIcon={false}>
          <CardTariffModalContentWrapper scrollTop={!modalActive}>
            <CloseImg setModalActive={setModalActive}/>
            {modalContents[modalContentIndex]}
          </CardTariffModalContentWrapper>
        </CardBorderGradient>
      </Modal>
      <Modal active={modalToolTipActive} setActive={setModalToolTipActive} zIndex="4">
        {modalToolTipContent}
      </Modal>
      <Modal active={formModalActive} setActive={setFormModalActive} zIndex="4">
        <CardBorderGradient isIcon={false}>
          <FormModalContentWrapper scrollTop={!formModalActive}>
          <CloseImg setModalActive={setFormModalActive}/>
            <FormModal
              title="Желаешь купить тариф?"
              description={
                <p>
                  Оставь свои контактные данные и мы <br /> свяжемся с тобой в
                  ближайшее время
                </p>
              }
            />
